...
[TestFixture]
[TestOf(typeof(FlashcardGameDatabaseContext))]
public class FlashcardGameDatabaseContextIntegrationTest
{
    ...
    public async Task AddFlashcardEntity_ShouldSaveToDatabase()
    {
        ...
        var savedFlashcard = await _dbContext.Flashcards
    ...
    public async Task GetFlashcardEntity_ShouldRetrieveFromDatabase()
    {
        ...
        var retrievedFlashcard = await _dbContext.Flashcards
                                                 .FirstOrDefaultAsync(f => f.Id == flashcard.Id);
    ...
    public async Task UpdateFlashcardEntity_ShouldPersistChanges()
    {
        ...
        // Modify the FlashcardEntity's words
        ...
        var updatedFlashcard = await _dbContext.Flashcards
                                               .FirstOrDefaultAsync(f => f.Id == flashcard.Id);
    ...
    public async Task DeleteFlashcardEntity_ShouldRemoveFromDatabase()
    {
        ...
        var deletedFlashcard = await _dbContext.Flashcards
                                               .FirstOrDefaultAsync(f => f.Id == flashcard.Id);
